...
const restaurantList = [
  ...
  },
  {
    ...
    cusines: ["Healthy Food", "Salads", "Snacks"],
    rating: "4.2",
    totalRating: "5K+",
    id:"4y0u-3"
  },
  ...
  },
  {
    ...
    cusines: ["Beverages", "Cafe","Deserts"],
    rating: "4.3",
    totalRating: "1K+",
    id:"lhto04"
  },
  ...
  },
  {
    ...
    cusines: ["Biryani", "Pastas","Punjabi"],
    rating: "4.2",
    totalRating: "1K+",
    id:"o4y0th739"
  },
...
const RestrauntCard = ({name,image,cusines,rating,totalRating}) => {
  // const {name,image,cusines,rating,totalRating} = props.restraunt
  // console.log(props)
  return (
    <div className="card">
      <img src={"https://res.cloudinary.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_660/"+image}></img>
      <h2>{name}</h2>
      <h3>{cusines.join(",")}</h3>
      <h4>{rating} Rating</h4>
